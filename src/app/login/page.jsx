...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-primary to-secondary px-5">
      <div className="bg-gradient-to-l from-primary to-secondary p-8 rounded shadow shadow-sky-500 w-full max-w-md">
