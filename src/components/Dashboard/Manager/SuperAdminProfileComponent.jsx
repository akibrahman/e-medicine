...
const SuperAdminProfileComponent = ({ user }) => {
  return (
    <div className="flex flex-col md:flex-row gap-4 items-center min-h-full px-20 md:px-32 py-5 bg-dashboard text-primary">
